...
public class Main extends JFrame implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if (e.getSource() == about)
        {
            String str
                        = "<html>"
                        + "<big>Scientific Calculator Version 3.1</big><br><br>"
                        + "<p>Prepared by  <b>Bushra Aboubida Ahmed</b><br><br>"
                        + "<p>Collaborators : Bushra Developement Comany ©</p>"
                        + "If you have any comments, ideas.. just let know<br><br>"
                        + "email: &nbsp Bushragtv@gmail.com<br>"
                        + "twitter & facebook: &nbsp @BushraTv<br><br>"
                        + "<u>Note</u><br>"
                        + "I used JDK 1.8 and NeatBeans to compile the source code.<br><br<br>"
                        + "<p><i>© CopyRight 2021 Bushra.Developement.Comany - All Rights Reserved</i></p>"
                        + "<html>";
